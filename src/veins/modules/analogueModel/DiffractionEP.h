#ifndef DIFFRACTIONEP_H_
#define DIFFRACTIONEP_H_
 ...
 */
class DiffractionEP: public AnalogueModel {
private:
     ...
     * */
    double getDiffParameter(double d1, double d2, double h);
...
public:
     ...
     */
    DiffractionEP(double carrierFrequency, bool considerDEM, std::vector<std::string> demFiles,
     ...
     *
     */
    DiffractionEP(double carrierFrequency, bool considerDEM, double demCellSize, double spacing,
            bool considerVehicles);
