...
class VegetationCOST : public AnalogueModel {
    protected:
    ...
    public:
        VegetationCOST(VegetationObstacleControl& vegetationObstacleControl, double carrierFrequency, const Coord& playgroundSize, bool leaf, bool debug);
