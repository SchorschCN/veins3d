...
/**
 * @brief AnalogueModel which selects a suitable model depending on the current situation.
 * At the moment, it only checks whether both vehicles are inside a parking garage or not.
 *
 *
 ...
 * respective models):
 * @verbatim
     <AnalogueModel type="ModelSelector">
 ...
 */
class ModelSelector : public AnalogueModel
{
public:
     ...
     */
    ModelSelector(double carrierFrequency, std::vector<std::string> demFiles, bool isRasterType, bool considerDEM,
