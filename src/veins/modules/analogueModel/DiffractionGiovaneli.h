#ifndef DIFFRACTIONGIOVANELI_H_
#define DIFFRACTIONGIOVANELI_H_
 ...
 */
class DiffractionGiovaneli: public AnalogueModel {
private:
    ...
    double getHighestVIndex(const std::map<double, double>& edgeMap, double a, double b);
...
public:
     ...
     */
    DiffractionGiovaneli(double carrierFrequency, bool considerDEM, std::vector<std::string> demFiles,
     ...
     *
     */
    DiffractionGiovaneli(double carrierFrequency, bool considerDEM, double demCellSize, double spacing,
            bool considerVehicles);
